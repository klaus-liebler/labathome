...
class HAL
{
    public:
        ...
        virtual ErrorCode GetCO2PPM(uint16_t *co2PPM)=0;
        virtual ErrorCode GetHeaterTemperature(float *degreesCelcius)=0;
        virtual ErrorCode GetAmbientBrightness(uint16_t *lux)=0;
        virtual ErrorCode GetAmbientBrightnessAnalog(uint16_t *lux)=0;
        virtual ErrorCode GetAmbientBrightnessDigital(uint16_t *lux)=0;
        ...
        virtual ErrorCode GetAirPressure_hPa(uint16_t *pa)=0;
