...
class ADCExperimentController extends ScreenController_1.ScreenController {
    constructor(appManagement, div) {
        ...
        this.chart = new chart_js_1.default(ctx, this.chartConfig);
            ...
            if (this.recording) {
                ...
                if (this.counter >= exports.CHART_EACH_INTERVAL) {
                    if (this.chartConfig.data.labels.length > 100) {
                        (_a = this.chartConfig.data.labels) === null || _a === void 0 ? void 0 : _a.shift();
                        this.chartConfig.data.datasets.forEach((dataset) => {
                            dataset.data.shift();
                        });
                    }
                    this.chartConfig.data.labels.push(now.toLocaleTimeString("de-DE"));
                    (_c = (_b = this.chartConfig.data) === null || _b === void 0 ? void 0 : _b.datasets[0].data) === null || _c === void 0 ? void 0 : _c.push(Values[0]);
                    (_e = (_d = this.chartConfig.data) === null || _d === void 0 ? void 0 : _d.datasets[1].data) === null || _e === void 0 ? void 0 : _e.push(Values[1]);
                    (_g = (_f = this.chartConfig.data) === null || _f === void 0 ? void 0 : _f.datasets[2].data) === null || _g === void 0 ? void 0 : _g.push(Values[2]);
                    (_j = (_h = this.chartConfig.data) === null || _h === void 0 ? void 0 : _h.datasets[3].data) === null || _j === void 0 ? void 0 : _j.push(Values[3]);
                    this.chart.update();
                    this.counter = 0;
                }
                this.counter++;
        ...
        xhr.onload = (e) => {
            ...
            if (this.recording) {
                ...
                if (this.counter >= CHART_EACH_INTERVAL) {
                    ...
                    this.chartConfig.data.labels.push(now.toLocaleTimeString("de-DE"));
                    (_c = (_b = this.chartConfig.data) === null || _b === void 0 ? void 0 : _b.datasets[0].data) === null || _c === void 0 ? void 0 : _c.push(SetpointAirspeed);
                    (_e = (_d = this.chartConfig.data) === null || _d === void 0 ? void 0 : _d.datasets[1].data) === null || _e === void 0 ? void 0 : _e.push(ActualAirspeed);
                    (_g = (_f = this.chartConfig.data) === null || _f === void 0 ? void 0 : _f.datasets[2].data) === null || _g === void 0 ? void 0 : _g.push(Fan);
                    (_j = (_h = this.chartConfig.data) === null || _h === void 0 ? void 0 : _h.datasets[3].data) === null || _j === void 0 ? void 0 : _j.push(Servo);
                    this.chart.update();
                    this.counter = 0;
                }
                this.counter++;
...
},{"./ScreenController":9,"./flowchart/SerializeContext":16,"./utils":20,"chart.js":1}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ADCExperimentController":3,"./AirspeedExperimentController":4,"./DevelopCFCController":6,"./DialogController":7,"./HeaterExperimentController":8,"./ScreenController":9}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ScreenController":9,"./flowchart/Flowchart":10}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
        ...
        xhr.onload = (e) => {
            ...
            if (this.recording) {
                ...
                if (this.counter >= exports.CHART_EACH_INTERVAL) {
                    ...
                    this.chartConfig.data.labels.push(now.toLocaleTimeString("de-DE"));
                    (_c = (_b = this.chartConfig.data) === null || _b === void 0 ? void 0 : _b.datasets[0].data) === null || _c === void 0 ? void 0 : _c.push(SetpointTemperature);
                    (_e = (_d = this.chartConfig.data) === null || _d === void 0 ? void 0 : _d.datasets[1].data) === null || _e === void 0 ? void 0 : _e.push(ActualTemperature);
                    (_g = (_f = this.chartConfig.data) === null || _f === void 0 ? void 0 : _f.datasets[2].data) === null || _g === void 0 ? void 0 : _g.push(Heater);
                    (_j = (_h = this.chartConfig.data) === null || _h === void 0 ? void 0 : _h.datasets[3].data) === null || _j === void 0 ? void 0 : _j.push(Fan);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Control_PID = exports.Custom_XYZBlock = exports.Sensor_HeaterTemperatureOperator = exports.Sensor_AmbientLightOperator = exports.Arithmetic_LessThanOperator = exports.Arithmetic_GreaterThanOperator = exports.Timing_TOFOperator = exports.Timing_TONOperator = exports.Bool2ColorConvert = exports.Arithmetic_ConstINTOperator = exports.Sound_Melody = exports.Logic_ConstTRUEOperator = exports.Output_Led7Operator = exports.Output_Led6Operator = exports.Output_Led5Operator = exports.Output_Led4Operator = exports.Output_Led3Operator = exports.Output_CommonRGBLedOperator = exports.Output_GreenLedOperator = exports.Output_YellowLedOperator = exports.Output_RedLedOperator = exports.Output_RelayOperator = exports.Sensor_AirTemperatureOperator = exports.Sensor_MovementOperator = exports.Input_RedButtonOperator = exports.Input_EncoderButtonOperator = exports.Input_GreenButtonOperator = exports.Logic_NotOperator = exports.Logic_RSOperator = exports.Arithmetic_MINOperator = exports.Arithmetic_MAXOperator = exports.Arithmetic_MULTIPLYOperator = exports.Arithmetic_ADDOperator = exports.Logic_OROperator = exports.Logic_ANDOperator = exports.OperatorRegistry = void 0;
const FlowchartOperator_1 = require("./FlowchartOperator");
const FlowchartConnector_1 = require("./FlowchartConnector");
const utils_1 = require("../utils");
...
class OperatorRegistry {
    ...
    static Build() {
        ...
        r.Register(1, Logic, "AND", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Logic_ANDOperator(p, ca, ti, co));
        r.Register(2, Logic, "OR", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Logic_OROperator(p, ca, ti, co));
        r.Register(3, Arithmetic, "ADD", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Arithmetic_ADDOperator(p, ca, ti, co));
        r.Register(4, Arithmetic, "MULTIPLY", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Arithmetic_MULTIPLYOperator(p, ca, ti, co));
        r.Register(5, Arithmetic, "MAX", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Arithmetic_MAXOperator(p, ca, ti, co));
        r.Register(6, Arithmetic, "MIN", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Arithmetic_MINOperator(p, ca, ti, co));
        r.Register(7, Logic, "RS", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Logic_RSOperator(p, ca, ti, co));
        r.Register(8, Logic, "NOT", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Logic_NotOperator(p, ca, ti, co));
        r.Register(9, Input, "GreenButton", FlowchartOperator_1.PositionType.Input, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Input_GreenButtonOperator(p, ca, ti, co));
        r.Register(10, Input, "EncoderButton", FlowchartOperator_1.PositionType.Input, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Input_EncoderButtonOperator(p, ca, ti, co));
        r.Register(11, Input, "RedButton", FlowchartOperator_1.PositionType.Input, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Input_RedButtonOperator(p, ca, ti, co));
        r.Register(12, Sensor, "Movement", FlowchartOperator_1.PositionType.Input, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Sensor_MovementOperator(p, ca, ti, co));
        r.Register(13, Sensor, "AirTemperature", FlowchartOperator_1.PositionType.Input, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Sensor_AirTemperatureOperator(p, ca, ti, co));
        r.Register(14, Output, "Relay", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Output_RelayOperator(p, ca, ti, co));
        r.Register(15, Output, "RedLed", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Output_RedLedOperator(p, ca, ti, co));
        r.Register(16, Output, "YellowLed", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Output_YellowLedOperator(p, ca, ti, co));
        r.Register(17, Output, "GreenLed", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Output_GreenLedOperator(p, ca, ti, co));
        r.Register(18, Logic, "ConstTRUE", FlowchartOperator_1.PositionType.Input, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Logic_ConstTRUEOperator(p, ca, ti, co));
        r.Register(19, Arithmetic, "ConstINT", FlowchartOperator_1.PositionType.Input, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Arithmetic_ConstINTOperator(p, ca, ti, co));
        r.Register(20, Timing, "TON", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Timing_TONOperator(p, ca, ti, co));
        r.Register(21, Timing, "TOF", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Timing_TOFOperator(p, ca, ti, co));
        r.Register(22, Arithmetic, "GreaterThan", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Arithmetic_GreaterThanOperator(p, ca, ti, co));
        r.Register(23, Arithmetic, "LessThan", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Arithmetic_LessThanOperator(p, ca, ti, co));
        r.Register(24, Sensor, "AmbientLight", FlowchartOperator_1.PositionType.Input, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Sensor_AmbientLightOperator(p, ca, ti, co));
        r.Register(25, Sensor, "HeaterTemperature", FlowchartOperator_1.PositionType.Input, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Sensor_HeaterTemperatureOperator(p, ca, ti, co));
        r.Register(26, Converter, "Bool2Color", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Bool2ColorConvert(p, ca, ti, co));
        r.Register(27, Output, "LED3", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Output_Led3Operator(p, ca, ti, co));
        r.Register(28, Output, "LED4", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Output_Led4Operator(p, ca, ti, co));
        r.Register(29, Output, "LED5", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Output_Led5Operator(p, ca, ti, co));
        r.Register(30, Output, "LED6", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Output_Led6Operator(p, ca, ti, co));
        r.Register(31, Output, "LED7", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Output_Led7Operator(p, ca, ti, co));
        r.Register(32, Sound, "Melody", FlowchartOperator_1.PositionType.Output, FlowchartOperator_1.SingletonType.Singleton, (p, ca, ti, co) => new Sound_Melody(p, ca, ti, co));
        r.Register(33, Control, "PID", FlowchartOperator_1.PositionType.Default, FlowchartOperator_1.SingletonType.Default, (p, ca, ti, co) => new Control_PID(p, ca, ti, co));
...
class Logic_ANDOperator extends FlowchartOperator_1.FlowchartOperator {
...
exports.Logic_ANDOperator = Logic_ANDOperator;
class Logic_OROperator extends FlowchartOperator_1.FlowchartOperator {
    constructor(parent, caption, ti, configurationData) {
        super(parent, caption, ti, configurationData);
        this.A = new FlowchartConnector_1.FlowchartInputConnector(this, "A", 0, FlowchartConnector_1.ConnectorType.BOOLEAN);
        this.B = new FlowchartConnector_1.FlowchartInputConnector(this, "B", 1, FlowchartConnector_1.ConnectorType.BOOLEAN);
...
exports.Logic_OROperator = Logic_OROperator;
...
class Logic_RSOperator extends FlowchartOperator_1.FlowchartOperator {
    constructor(parent, caption, ti, configurationData) {
        super(parent, caption, ti, configurationData);
        this.state = false;
...
exports.Logic_RSOperator = Logic_RSOperator;
class Logic_NotOperator extends FlowchartOperator_1.FlowchartOperator {
    constructor(parent, caption, ti, configurationData) {
        super(parent, caption, ti, configurationData);
...
exports.Logic_NotOperator = Logic_NotOperator;
...
class Sensor_AirTemperatureOperator extends FlowchartOperator_1.FlowchartOperator {
    constructor(parent, caption, ti, configurationData) {
        super(parent, caption, ti, configurationData);
        let O = new FlowchartConnector_1.FlowchartOutputConnector(this, "Temperature*10", 0, FlowchartConnector_1.ConnectorType.INTEGER);
        this.AppendConnectors([], [O]);
        this.StorageId = "4711";
    }
}
exports.Sensor_AirTemperatureOperator = Sensor_AirTemperatureOperator;
...
class Logic_ConstTRUEOperator extends FlowchartOperator_1.FlowchartOperator {
    constructor(parent, caption, ti, configurationData) {
        super(parent, caption, ti, configurationData);
        let O = new FlowchartConnector_1.FlowchartOutputConnector(this, "TRUE", 0, FlowchartConnector_1.ConnectorType.BOOLEAN);
        this.AppendConnectors([], [O]);
    }
}
exports.Logic_ConstTRUEOperator = Logic_ConstTRUEOperator;
...
class Timing_TONOperator extends FlowchartOperator_1.FlowchartOperator {
    constructor(parent, caption, ti, configurationData) {
        super(parent, caption, ti, configurationData);
...
exports.Timing_TONOperator = Timing_TONOperator;
class Timing_TOFOperator extends FlowchartOperator_1.FlowchartOperator {
    constructor(parent, caption, ti, configurationData) {
        super(parent, caption, ti, configurationData);
        this.lastInputValue = false;
...
exports.Timing_TOFOperator = Timing_TOFOperator;
...
class Sensor_AmbientLightOperator extends FlowchartOperator_1.FlowchartOperator {
    constructor(parent, caption, ti, configurationData) {
        super(parent, caption, ti, configurationData);
        let O = new FlowchartConnector_1.FlowchartOutputConnector(this, "Lux", 0, FlowchartConnector_1.ConnectorType.INTEGER);
        this.AppendConnectors([], [O]);
    }
}
exports.Sensor_AmbientLightOperator = Sensor_AmbientLightOperator;
class Sensor_HeaterTemperatureOperator extends FlowchartOperator_1.FlowchartOperator {
    constructor(parent, caption, ti, configurationData) {
        super(parent, caption, ti, configurationData);
        let O = new FlowchartConnector_1.FlowchartOutputConnector(this, "Degrees", 0, FlowchartConnector_1.ConnectorType.INTEGER);
        this.AppendConnectors([], [O]);
    }
}
